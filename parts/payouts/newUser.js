    ...
    const data = {
      refreshUrl:
        process.env.NEXT_PUBLIC_NODE_ENV === "development"
          ? "https://stg.bidsloth.com/payouts"
          : "https://bidsloth.com/payouts",
      returnUrl:
        process.env.NEXT_PUBLIC_NODE_ENV === "development"
          ? "https://stg.bidsloth.com/payouts"
          : "https://bidsloth.com/payouts",
    ...
    <GridStyles>
      <div className="welcome">
        <div className="welcome-text">
          <h3>The power of Stripe!</h3>

          <p className="intro">Bidsloth is powered by stripe! Making</p>
          <p className="intro">payouts to you instant! </p>
          <p className="intro">Create or connect your stripe account!</p>
          ...
          />
          <div className="note payout new">
            It’s free to get started. We keep 10% of the auction price and a
            small stripe fee (~3%).
          </div>
        </div>
      ...
      {/* <div className="payout-footer">
        <p className="off">
          To keep the light on, and the improvements rolling, we take a 10% cut on
          the final price! And Stripe, our payment processor, charge a credit card
          fee.
        </p>
      </div> */}
    </GridStyles>
